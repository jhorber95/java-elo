...
@Component({
  selector: 'app-fase6',
  templateUrl: './fase6.component.html',
  styleUrls: ['./fase6.component.css']
})
export class Fase6Component implements OnInit, AfterViewInit {
  ...
  NextFase() {
    if(this.ValidateItems()){
      ...
      this.workFlowTestService.validateStep(STEPS.fase6);
      // redirigir
      this.router.navigate(['/test/fase7']);
    }else{
