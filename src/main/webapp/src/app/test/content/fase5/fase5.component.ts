...
@Component({
  selector: 'app-fase5',
  templateUrl: './fase5.component.html',
  styleUrls: ['./fase5.component.css']
})
export class Fase5Component implements OnInit, AfterViewInit {
  ...
  NextFase() {
    if(this.ValidateItems()){
      ...
      this.workFlowTestService.validateStep(STEPS.fase5);
      // redirigir
      this.router.navigate(['/test/fase6']);
    }else{
